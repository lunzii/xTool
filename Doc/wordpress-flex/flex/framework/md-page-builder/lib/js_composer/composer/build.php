...
class WPBakeryVisualComposerSetupAdmin extends WPBakeryVisualComposerSetup {
    ...
    public function setUpPlugin() {
        ...
        if ($show) {
            ...
            $this->composer->addAction('wp_ajax_wpb_reload_templates', 'reloadTemplatesJavascript_callback');
    ...
    public function registerJavascript() {
        ...
        wp_localize_script( 'wpb_js_composer_js_view', 'i18nLocale', array(
            ...
            'main_button_title' => __( 'MD Page Builder', 'js_composer' ),
    ...
    public function jsComposerEditPage() {
        ...
        foreach ($pt_array as $pt) {
            add_meta_box( 'wpb_visual_composer', __('MD Page Builder', "js_composer"), Array($this->composer->getLayout(), 'output'), $pt, 'normal', 'high');
        }
    }
