...
class WPBakeryVisualComposerSettings {
    ...
    public function init() {
        ...
        $page = add_options_page(__("MD Page Builder Settings", "js_composer"),
            __("MD Page Builder", "js_composer"),
            'manage_options',
            $this->page,
            array(&$this, 'output'));
...
* @param $callback - function to build section header.
    ...
    public function content_types_field_callback() {
        ...
        ?>
        <p class="description indicator-hint"><?php _e("Select for which content types MD Page Builder should be available during post creation/editing.", "js_composer"); ?></p>
        <?php
    }
...
<div class="wrap vc-settings" id="wpb-js-composer-settings">
    <?php screen_icon(); ?>
    <h2><?php _e('Md Page Builder', 'js_composer'); ?></h2>
    <?php
    ?>
