...
class WPBakeryVisualComposerElementButton implements WPBakeryVisualComposerTemplateInterface {
    ...
    public function output($post = null) {
        ...
        $output .= '<li data-element="' . $this->base . '" class="wpb-layout-element-button'.$category_css_classes.$class_out.'"'.$data.'><a id="' . $this->base . '" class="dropable_el clickable_action'.$class.'" href="#">' .htmlspecialchars(__(stripslashes($this->params["name"]), "js_composer")) .'</a></li>';
        return $output;
    }
}
    ...
    public function getElementsModal() {
        ...
        <div class="modal wpb-elements-list-modal">
          <div class="modal-header">
            ...
            <h3>'.__('MD SHORTCODES', 'js_composer').'</h3>
        ...
        <div class="modal wpb-element-edit-modal">
            ...
            <div class="modal-body wpb-edit-form">
                <div class="vc_row-fluid wpb-edit-form-inner">
                    <div class="vc_loading_block"><div class="blocker"><i class="icon-spinner"></i></div></div>
                </div>
            </div>
            <div class="modal-footer text-center">
                <button class="button-primary wpb_save_edit_form" data-dismiss="modal" aria-hidden="true"><i class="icon-ok"></i></button>
    ...
    function buildButtons() {
        ...
        $buttons = array(
            array(
                ...
                '<ul class="vc_nav">
                              <li>
                                <a class="wpb_add_new_row dropable_row button" id="wpb-add-new-row" data-element="vc_row">Add Section</a>
                                </li>
                            </ul>'
            ),
            array(
                ...
                '<ul class="vc_nav">
                                <li>
                                    <a class="wpb_add_new_element dropable_el button" id="wpb-add-new-element">'.__('Add element', 'js_composer').'</a>
                                </li>
                            </ul>'
            ),
            array(
                ...
                '<ul class="vc_nav">
                                <li class="vc_dropdown">
                                    <a class="wpb_templates button">'.__('Templates', 'js_composer').' <b class="caret"></b></a>
            ...
            array(
                ...
                '<ul class="vc_nav">
                                <li>
                                    <a href="#" class="button" id="wpb_save_template_button">'.__('Save page as a Template', 'js_composer').'</a>
                                </li>
                            </ul>'
            ),
            ...
            array(
                'load_demo_templates',
                '<ul class="vc_nav">
                                <li id="wpb_save_template">
                                    <a class="wpb_import_templates button">'.__('Import Demo Templates', 'js_composer').'</a>
                                </li>
                            </ul>'
            )
        );
    ...
    public function output($post = null) {
        ...
        <div class="metabox-composer-content">
					<div id="wpb-convert-message">
					   <div class="messagebox_text"><p>'.__('Your page layout was created with previous MD Page Builder version.', 'js_composer').'</p>
                ...
                <div class="vc_loading_block" style="display: none;"><i class="icon-spinner"></i></div>
